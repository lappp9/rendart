...
$(function() {
  ...
  images = [
    <%= asset_data_uri("cequel.jpg") %>, 
    <%= asset_data_uri("cequel3.jpg") %>, 
    <%= asset_data_uri("cequel7.jpg") %>, 
    <%= asset_data_uri("ameren2.jpg") %>, 
    <%= asset_data_uri("ameren.jpg") %>, 
    <%= asset_data_uri("residential5.jpg") %>, 
    <%= asset_data_uri("residential.jpg") %>, 
    <%= asset_data_uri("cozzens3.jpg") %>, 
    <%= asset_data_uri("residential6.jpg") %>, 
    <%= asset_data_uri("sketch4.JPG") %>, 
    <%= asset_data_uri("station4.jpg") %>, 
    <%= asset_data_uri("physical.JPG") %>, 
    <%= asset_data_uri("ka.jpg") %>
  ];
  ...
  $("#left").click(function(e) {
    e.preventDefault();
    $("#content").css("background-image", "url(" + images[lastImage()] + ")");
  });

  $("#right").click(function(e) {
    e.preventDefault();
    $("#content").css("background-image", "url(" + images[nextImage()] + ")");
  });
